# -*- coding: utf-8 -*-
"""broken_202211161559_pytorch_smp.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1n5tqwrpuXuPXwSZUHRmMah9GKt3qdtOp
...
# https://colab.research.google.com/drive/1gq-BxFLI-lCsOkXG9n4-nHcf69FkyAS6?authuser=2#scrollTo=9U7_I2Ru259b
...
# Visualize image and corresponding mask
...
# Image conversion helper functions (3-channel RGB to 1-channel label index)
...
# Define lists of images and labels
...
# We can read images, extract values of classes from segmentation mask, apply augmentation, and pre-processing transformations
...
class Dataset(BaseDataset):
    ...
    def __getitem__(self, i):
        ...
        # apply augmentatioagmentation(image=image, mask=mask)
...
# Visualize segmentation masks for all classes
...
# Define dataloaders and set batch size to 6, because of memory limitation
...
callbacks = [
    ...
    #this is the block that should contain the per_class argument
    #https://catalyst-team.github.io/catalyst/v20.12/api/callbacks.html?highlight=ioucallback#catalyst.callbacks.metrics.iou.IouCallback
